    ...
    <div className="flex flex-col items-center justify-center min-h-screen">
      <div className="text-center mb-16 mt-48">
        ...
        <p className="text-xl mb-8 max-w-2xl">
          The OM-backed stablecoin for the Emirati Dirham. Secure, stable, and decentralized.
        </p>
      </div>
      ...
      <div className="w-full mb-32 px-4 max-w-6xl">
        ...
        <div className="text-left mb-16">
          ...
          <p className="w-2/3 text-xl">
            Crypto volatility? Not here. Dira transforms your OM into a rock-solid digital dirham, turning crypto complexity into simple, reliable value.
          </p>
        </div>
